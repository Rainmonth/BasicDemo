...
public class FloatWindowManager {
     ...
     * 悬浮窗
     */
    private static KaDaStoryFloatWindow mFloatLayout;
    ...
    public static void createFloatWindow(Context context) {
        ...
        mFloatLayout = new KaDaStoryFloatWindow(context);
        ...
        mFloatLayout.setWindowLayoutParams(wmParams);
    ...
    public static KaDaStoryFloatWindow getFloatWindow() {
        return mFloatLayout;
    }
    ...
    public static float getMoveDistance(int direction) {
        if (mFloatLayout != null) {
            return mFloatLayout.getStayMoveDistance(direction);
        }
        return 0;
    }
}
